# Superseded by backend/app/diarization.py (cleaned, binary-search word
# alignment, proper interval-merge overlap detection). Kept as the original
# Colab prototype for reference.
